                  ...
                  <div className="dashboard-card glass-panel global-modal-container">
                        ...
                        {loading ? (
                              ...
                              <div style={{ padding: '2rem' }}>
                                    ...
                                    <div>
                                          <h3 style={{ fontSize: '1.1rem', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}><FileText className="text-purple-400" size={20} /> Recent Ledger Activity</h3>
